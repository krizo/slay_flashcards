...
from sqlalchemy import func, select  # pylint: disable=import-error
...
class BaseRepository(Generic[ModelType], ABC):
    ...
    def get_by_id(self, id: Any) -> Optional[ModelType]:  # pylint: disable=redefined-builtin
        """
    ...
    def count(self) -> int:
        ...
        """
        stmt = select(func.count()).select_from(self.model_class) # pylint: disable=not-callable
        return self.db.scalar(stmt) or 0


    def exists(self, id: Any) -> bool:  # pylint: disable=redefined-builtin
        """
    ...
    def delete_by_id(self, id: Any) -> bool:  # pylint: disable=redefined-builtin
        """
